...
<h4 class="center">Please Submit the below form for reservation.</h4>
<form action="add" onsubmit="return validate()" class="center">
	...
	Date of starting to stay: <input type="date" name="dateofstarting" class="demo" onblur="cleanup(this)"><b></b><br><br>
	
	Date of leaving: <input type="date" name="dateofleaving" class="demo" onblur="cleanup(this)"><b></b><br><br>
